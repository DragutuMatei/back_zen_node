...
app.post("/deleteStoreCodes", deleteStoreCodes);
app.post("/updateStoreCodes", updateStoreCodes);
app.post("/getRawStoreCodes", getRawStoreCodes);
app.post("/deleteSingleStoreCode", deleteSingleStoreCode);
